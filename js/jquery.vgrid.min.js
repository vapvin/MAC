...
(function(i) {
  ...
  function d(v, r) {
    ...
    for (var u = 0, t = w.length; u < t; u++) {
      ...
      if (
        s.length > 0 &&
        s[s.length - 1][1] === w[u][0] &&
        s[s.length - 1][2] === w[u][2]
      ) {
  ...
  function q(t) {
    ...
    r +=
      h(t.css("margin-left")) +
      h(t.css("padding-left")) +
      h(t.css("border-left-width")) +
      h(t.css("margin-right")) +
      h(t.css("padding-right")) +
      h(t.css("border-right-width"));
    s +=
      h(t.css("margin-top")) +
      h(t.css("padding-top")) +
      h(t.css("border-top-width")) +
      h(t.css("margin-bottom")) +
      h(t.css("padding-bottom")) +
    ...
    if (z) {
      ...
      x.each(function(C) {
        ...
        B.data(
          ...
          setTimeout(function() {
            B.animate(
              { left: B.data("_vgleft") + "px", top: B.data("_vgtop") + "px" },
              D
            );
          }, C * u)
        );
    ...
    r.each(function(t) {
      ...
      s.data(
        ...
        setTimeout(function() {
          ...
          o(
            s.data("_vgchild"),
            s.data("_vgopt").easing || "linear",
            e(s.data("_vgopt").time, 500),
            e(s.data("_vgopt").delay, 0)
          );
    ...
    vgrid: function(t) {
      ...
      r.each(function() {
        ...
        if (u.data("_vgopt").fadeIn) {
          var v =
            typeof u.data("_vgopt").fadeIn === "object"
              ? u.data("_vgopt").fadeIn
    ...
    vgsort: function(t, v, u, s) {
      ...
      r.each(function() {
        ...
        if (w.data("_vgchild")) {
          ...
          o(
            w.data("_vgchild"),
            v || w.data("_vgopt").easing || "linear",
            e(u, e(w.data("_vgopt").time, 500)),
            e(s, e(w.data("_vgopt").delay, 0))
          );
        }
      });
      return r;
